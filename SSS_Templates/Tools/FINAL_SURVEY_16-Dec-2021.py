...
DocumentPath = r"\\AD007APP06\\gisapplications\\arcgisdata\\Smartsurvey\\" + TempalteName +  ".mxd"
...
#-----------------------------------------------------------------------------------------------------------
pCursor = arcpy.SearchCursor(r"\\ad007app06\gisapplications\arcgisdata\Smartsurvey\Layers\S_TSUR_POINT.lyr","REQNUM = '" + REQNUM + "'")
#-----------------------------------------------------------------------------------------------------------
pCoordinates = []
for row in pCursor:
