...
#===========================================================================================================
arcpy.AddMessage(OPERATIONID)
wtypeid_cut_gap_ext_list = [4,11,17,5,12,16,20]
wtypeid_Nocolumns_list = [1,2,3,7,8,9,10,13,14,15]

if (OPERATIONID in wtypeid_cut_gap_ext_list):
        DocumentPath = r"//AD007APP06/gisapplications/gisapps/sddsps/Templates/" + TempalteName + "_4R" +  ".mxd"
        mxd = arcpy.mapping.MapDocument(DocumentPath)
        pDataFrame = arcpy.mapping.ListDataFrames(mxd, "Layers")[0]
        pSpatialReference = pDataFrame.spatialReference
##elif (WTYPEID in wtypeid_Nocolumns_list):
##        DocumentPath = r"//ap007fsc05fs/GISApplications/agsadmgis/arcgisdata/SPS/Templates/" + TempalteName +  ".mxd"
##
##        mxd = arcpy.mapping.MapDocument(DocumentPath)
##        pDataFrame = arcpy.mapping.ListDataFrames(mxd, "Layers")[0]
##        pSpatialReference = pDataFrame.spatialReference
elif OPERATIONID == 21:
        DocumentPath = r"//AD007APP06/gisapplications/gisapps/sddsps/Templates/"+ TempalteName + "_6R" +  ".mxd"
        mxd = arcpy.mapping.MapDocument(DocumentPath)
        pDataFrame = arcpy.mapping.ListDataFrames(mxd, "Layers")[0]
        pSpatialReference = pDataFrame.spatialReference
#-----------------------------------------------------------------------------------------------------------
...
##                pDataFrame.scale = m
        ...
        if ORDERBY == 'PlotNumber':
                ...
                order = 'ORDER BY (case when REGEXP_LIKE (PLOTNUMBER ,\'^[[:digit:]]+$\') then LPAD(PLOTNUMBER, 10)else PLOTNUMBER end)'
        ...
        cut_gap_ext_TxtElems = arcpy.mapping.ListLayoutElements(mxd, "TEXT_ELEMENT", "CUT_GAP_EXT_*")
...
##                 plotTxtElems[i].delete
                for elm in appvdPlotsTxtElems + areaPlotElems + extPlotElems + gapPlotElems + cutPlotElems + plotTxtElems + cut_gap_ext_TxtElems:
                        elm.delete()
...
##                        else: elm.text = CopyTo
                ...
                #+++++++++++++++++++++++++++++++++++++++++++
                if OPERATIONID == 20:
                        if elm.name == "CUT_GAP_EXT":
                                if len(SM_PLOTS) > 37: elm.delete()
                                else: elm.text = "M≤ «·≈” ﬁÿ«⁄"
                        if elm.name == "CUT_GAP_EXT_1":
                                if len(SM_PLOTS) < 1: elm.delete()
                                else: elm.text = SM_PLOTS[0][9]	   
                        if elm.name == "CUT_GAP_EXT_2":
                                if len(SM_PLOTS) < 2: elm.delete()
                                else: elm.text = SM_PLOTS[1][9]	   
                        if elm.name == "CUT_GAP_EXT_3":
                                if len(SM_PLOTS) < 3: elm.delete()
                                else: elm.text = SM_PLOTS[2][9]	   
                        if elm.name == "CUT_GAP_EXT_4":
                                if len(SM_PLOTS) < 4: elm.delete()
                                else: elm.text = SM_PLOTS[3][9]	   
                        if elm.name == "CUT_GAP_EXT_5":
                                if len(SM_PLOTS) < 5: elm.delete()
                                else: elm.text = SM_PLOTS[4][9]	   
                        if elm.name == "CUT_GAP_EXT_6":
                                if len(SM_PLOTS) < 6: elm.delete()
                                else: elm.text = SM_PLOTS[5][9]	   
                        if elm.name == "CUT_GAP_EXT_7":
                                if len(SM_PLOTS) < 7: elm.delete()
                                else: elm.text = SM_PLOTS[6][9]	   
                        if elm.name == "CUT_GAP_EXT_8":
                                if len(SM_PLOTS) < 8: elm.delete()
                                else: elm.text = SM_PLOTS[7][9]	   
                        if elm.name == "CUT_GAP_EXT_9":
                                if len(SM_PLOTS) < 9:elm.delete()
                                else: elm.text = SM_PLOTS[8][9]	   
                        if elm.name == "CUT_GAP_EXT_10":
                                if len(SM_PLOTS) < 10: elm.delete()
                                else: elm.text = SM_PLOTS[9][9]	   
                        if elm.name == "CUT_GAP_EXT_11":
                                if len(SM_PLOTS) < 11: elm.delete()
                                else: elm.text = SM_PLOTS[10][9]	   
                        if elm.name == "CUT_GAP_EXT_12":
                                if len(SM_PLOTS) < 12: elm.delete()
                                else: elm.text = SM_PLOTS[11][9]	   
                        if elm.name == "CUT_GAP_EXT_13":
                                if len(SM_PLOTS) < 13: elm.delete()
                                else: elm.text = SM_PLOTS[12][9]	   
                        if elm.name == "CUT_GAP_EXT_14":
                                if len(SM_PLOTS) < 14: elm.delete()
                                else: elm.text = SM_PLOTS[13][9]	   
                        if elm.name == "CUT_GAP_EXT_15":
                                if len(SM_PLOTS) < 15: elm.delete()
                                else: elm.text = SM_PLOTS[14][9]	   
                        if elm.name == "CUT_GAP_EXT_16":
                                if len(SM_PLOTS) < 16: elm.delete()
                                else: elm.text = SM_PLOTS[15][9]	   
                        if elm.name == "CUT_GAP_EXT_17":
                                if len(SM_PLOTS) < 17: elm.delete()
                                else: elm.text = SM_PLOTS[16][9]	   
                        if elm.name == "CUT_GAP_EXT_18":
                                if len(SM_PLOTS) < 18: elm.delete()
                                else: elm.text = SM_PLOTS[17][9]	   
                        if elm.name == "CUT_GAP_EXT_19":
                                if len(SM_PLOTS) < 19: elm.delete()
                                else: elm.text = SM_PLOTS[18][9]	   
                        if elm.name == "CUT_GAP_EXT_20":
                                if len(SM_PLOTS) < 20: elm.delete()
                                else: elm.text = SM_PLOTS[19][9]	   
                        if elm.name == "CUT_GAP_EXT_21":
                                if len(SM_PLOTS) < 21: elm.delete()
                                else: elm.text = SM_PLOTS[20][9]	   
                        if elm.name == "CUT_GAP_EXT_22":
                                if len(SM_PLOTS) < 22: elm.delete()
                                else: elm.text = SM_PLOTS[21][9]	   
                        if elm.name == "CUT_GAP_EXT_23":
                                if len(SM_PLOTS) < 23: elm.delete()
                                else: elm.text = SM_PLOTS[22][9]	   
                        if elm.name == "CUT_GAP_EXT_24":
                                if len(SM_PLOTS) < 24: elm.delete()
                                else: elm.text = SM_PLOTS[23][9]	   
                        if elm.name == "CUT_GAP_EXT_25":
                                if len(SM_PLOTS) < 25: elm.delete()
                                else: elm.text = SM_PLOTS[24][9]	   
                        if elm.name == "CUT_GAP_EXT_26":
                                if len(SM_PLOTS) < 26: elm.delete()
                                else: elm.text = SM_PLOTS[25][9]	   
                        if elm.name == "CUT_GAP_EXT_27":
                                if len(SM_PLOTS) < 27: elm.delete()
                                else: elm.text = SM_PLOTS[26][9]	   
                        if elm.name == "CUT_GAP_EXT_28":
                                if len(SM_PLOTS) < 28: elm.delete()
                                else: elm.text = SM_PLOTS[27][9]	   
                        if elm.name == "CUT_GAP_EXT_29":
                                if len(SM_PLOTS) < 29: elm.delete()
                                else: elm.text = SM_PLOTS[28][9]	   
                        if elm.name == "CUT_GAP_EXT_30":
                                if len(SM_PLOTS) < 30: elm.delete()
                                else: elm.text = SM_PLOTS[29][9]	   
                        if elm.name == "CUT_GAP_EXT_31":
                                if len(SM_PLOTS) < 31: elm.delete()
                                else: elm.text = SM_PLOTS[30][9]	   
                        if elm.name == "CUT_GAP_EXT_32":
                                if len(SM_PLOTS) < 32: elm.delete()
                                else: elm.text = SM_PLOTS[31][9]	   
                        if elm.name == "CUT_GAP_EXT_33":
                                if len(SM_PLOTS) < 33: elm.delete()
                                else: elm.text = SM_PLOTS[32][9]	   
                        if elm.name == "CUT_GAP_EXT_34":
                                if len(SM_PLOTS) < 34: elm.delete()
                                else: elm.text = SM_PLOTS[33][9]	   
                        if elm.name == "CUT_GAP_EXT_35":
                                if len(SM_PLOTS) < 35: elm.delete()
                                else: elm.text = SM_PLOTS[34][9]
                        if elm.name == "CUT_GAP_EXT_36":
                                if len(SM_PLOTS) < 36: elm.delete()
                                else: elm.text = SM_PLOTS[35][9]
                        if elm.name == "CUT_GAP_EXT_37":
                                if len(SM_PLOTS) < 37: elm.delete()
                                else: elm.text = SM_PLOTS[36][9]
                #+++++++++++++++++++++++++++++++++++++++++++
                #+++++++++++++++++++++++++++++++++++++++++++
                wtypeid_gap_list = [5,12,16]
                if (OPERATIONID in wtypeid_gap_list):
                        if elm.name == "CUT_GAP_EXT":
                                if len(SM_PLOTS) > 37: elm.delete()
                                else: elm.text = "M≤ ÷„ «·›«’·"
                        if elm.name == "CUT_GAP_EXT_1":
                ...
                #+++++++++++++++++++++++++++++++++++++++++++
                #+++++++++++++++++++++++++++++++++++++++++++
                wtypeid_ext_list = [4,11,17]
                if (OPERATIONID in wtypeid_ext_list):
                        if elm.name == "CUT_GAP_EXT":
                                if len(SM_PLOTS) > 37: elm.delete()
                                else: elm.text = "M≤  «·“Ì«œ…"
                        if elm.name == "CUT_GAP_EXT_1":
...
qÍDá>∑’7HÆ~      A b u   D h a b i   M u n i c i p     i t y \ D o c u m e n t s \ A r c G I S \ D e f a u l t . g       u˛qÍDá>∑’7HÆ~                                             ˇˇ    ˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇˇ     ˇˇ    Ok»Ü'   ñƒÈ~#—–ÉÉ 	πñÃ(     LsŸ¨ÃW@¨Ü¸G5¿)PŸWF˚_”ül ¿Ok»Ü'   ñƒÈ~#—–ÉÉ 	πñÃ(     LsŸ¨ÃW@¨Ü¸G5¿)≠¡∫`¿     ñƒÈ~#—–ÉÉ 	πñÃ)     k$b_¿+X@7∏ Nk4¿5Ò&å◊U@ R„ëèŒù„ ™ K∏Q*  ≤  êÄ8 ArialR„ëèŒù„ ™ K∏Q+  ≤  êDB ArialñƒÈ~#—–ÉÉ 	πñÃ,                              ñƒÈ~#—–ÉÉ 	πñÃ-                                 *   ˇˇ  ˇˇ     #     rƒZ|
 Ù?ÿ*¡‚pfÚ?ˇˇ8  < L a y o u t > < C o m m o n   C o m p a c t M o d e = " 1 " > < S u m m a r y   P a n e s = " 2 "   T o p C o n t a i n e r = " 1 "   C l i e n t = " 2 " / > < P a n e - 1   T y p e = " 2 "   P a n e s = " 1 "   P a n e - 1 = " 2 " / > < P a n e - 2   T y p e = " 4 " / > < / C o m m o n > < / L a y o u t >   ˇˇˇˇ            GO~Té“™ÿ      &        n◊î›mÉ–áÏ 	Ïs*‘                   GO~Té“™ÿ      &                                        NA    ñƒÈ~#—–ÉÉ 	πñÃ   Êyí»–ã∂ 	ÓNA    ˘Âyí»–ã∂ 	ÓNA    ñƒÈ~#—–ÉÉ 	πñÃ   n◊î›mÉ–áÏ 	Ïs*‘       |   v      ”4@ Íˆ–É≠ 	πñÃ’        T e m p l a t e N a m e   
   T e x t     ˇˇ              T e m p l a t e N a m e       t>Z∂ì)—öC Ä«Ï\ñ÷    ñƒÈ~#—–ÉÉ 	πñÃ◊                               ˇˇˇˇ                                        ñƒÈ~#—–ÉÉ 	πñÃÿ                                                                      Y@      Y@                    v>Z∂ì)—öC Ä«Ï\ñ                                   T e m p l a t e N a m e         @          @Êyí»–ã∂ 	ÓNAŸ    ˘Âyí»–ã∂ 	ÓNA⁄    ñƒÈ~#—–ÉÉ 	πñÃ€      ≈®$öK@                                    ñƒÈ~#—–ÉÉ 	πñÃ‹            Y@              =            R„ëèŒù„ ™ K∏Q›      º¨ Arialˇˇëõ	◊ò‚ûIóWrª9Â\Û  AÀ• ⁄R–®Ú `åÖÌÂﬁ           ‹$Åï)@  ^K»›?k¿Ü≤y“™  ¿O£< ﬂ       U n k n o w n                         à√¿     à√¿     à√@     ˘5¡    ÄÑ.A     ˘5¡    ÄÑ.A¸©Ò“MbP?çÌµ†˜∆¿>çÌµ†˜∆¿>    ˇˇˇˇi      ±òE»æƒBë2≠¢æWÛ‡    –•›b“áæ  ¯u ·            ˘Âyí»–ã∂ 	ÓNA‚    ñƒÈ~#—–ÉÉ 	πñÃ„                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 