...
zipFolder = r"\\ap007fsn01\GISApplications\ESRIApplications\arcgisdata\DashboardPrint\zipContents"
                ...
                for s in data['results']:
                    for key in sorted(s):
                        ...
                        if a == "2019 / 2016 عدد السكان":
                            ...
                            foodtruckpermit_Count = name + ": " + val
                        elif a == "تراخيص دائرة التنمية الاقتصادية":
                            DEDLICENSES_Count = name + ": " + val
                        elif a == "DED LICENSES":
                            DEDLICENSES_Count = name + ": " + val
                        elif a == "NBM Bulding":
                            NBMBulding = name + ": " + val
...
#-----------------------------------------------------------------------------------------------------------
if lang == "AR":
    DocumentPath = r"\\ap007fsn01\GISApplications\ESRIApplications\arcgisdata\DashboardPrint\A3_Template_AR.mxd"
if lang == "EN":
    DocumentPath = r"\\ap007fsn01\GISApplications\ESRIApplications\arcgisdata\DashboardPrint\A3_Template_EN.mxd"
...
for elm in arcpy.mapping.ListLayoutElements(mxd, "TEXT_ELEMENT"):
    ...
    if elm.name == "DEDLICENSES_Count":
        if DEDLICENSES_Count is None: elm.text = " "
        else: elm.text = DEDLICENSES_Count
